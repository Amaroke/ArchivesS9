...
public class ModifierTrainController implements Initializable {
    ...
    private void onValiderClick() {
        ...
        try {
            ...
            port.updateTrain(numeroTrain, villeDepart, villeArrivee, dateDepart, heureInt, prixBillet,
                    placesDisponibles, "valide");
